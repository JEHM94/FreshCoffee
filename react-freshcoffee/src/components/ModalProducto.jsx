    ...
    return (
        <div className="md:flex gap-10">
            ...
            <div className="md:w-2/3">
                ...
                <div className="flex gap-4 mt-5 md:justify-start justify-between">
                    <button
                        type="button"
                        onClick={() => {
                ...
                <button
                    type="button"
                    className="w-full md:w-auto bg-indigo-600 hover:bg-indigo-700 px-5 py-2 mt-5 text-white font-bold uppercase rounded"
                    onClick={() => {
